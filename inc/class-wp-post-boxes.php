	...
	function save( $post_id ) {
		...
		foreach ($this->meta_fields as $field) {
			if(isset($_POST[$field])){
				$meta = is_array($_POST[$field]) ? $this->array_map_recursive('sanitize_text_field', $_POST[$field]) : sanitize_text_field( $_POST[$field] );

				// $meta = is_array($_POST[$field]) ? array_filter($_POST[$field], 'sanitize_text_field') : sanitize_text_field( $_POST[$field] );
